...
- Trigger: `@Romi` prefix (case insensitive), configurable via `ASSISTANT_NAME` env var
...
- **Trigger**: `@Romi` (case insensitive)
- **Response prefix**: `Romi:`
- **Persona**: Friendly dog personality (loyal, enthusiastic, eager to help)
